...
namespace MVC.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var bookings = db.Bookings.Include(b => b.Client).Include(b => b.Event);
        ...
        public ActionResult Create([Bind(Include = "Payment,DateBooked,ClientID,EventID,BookingID")] Booking booking)
        {
            ...
            ViewBag.ClientID = new SelectList(db.Clients, "ClientID", "GivenName", booking.ClientID);
            ViewBag.EventID = new SelectList(db.Events, "EventID", "EventID", booking.EventID);
            return View(booking);
        }
